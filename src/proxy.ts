...
/**
 * Proxy for route protection and RBAC (Next.js 16+)
 * 
 * ✅ ENABLED: Authentication and RBAC are now active
 * - Public routes: /, /search, /docs
 * - Protected routes: /admin/* (requires authentication and role check)
 */
